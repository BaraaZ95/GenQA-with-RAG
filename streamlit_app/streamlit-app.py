...
def LLM_chain_response():
    prompt = PromptTemplate(
        ...
        template="You are an expert at question answering. Answer the question based on the context below. If you cannot answer based on the context "
...
splade = SPLADE("Baraa/splade-cocondenser-ensembledistil")
...
def get_text():
    input_text = st.text_input(
        "You: ", "Is Wells Fargo a successful bank?", key="input"
    )
    return input_text
